...
const componentClass = [
  'list-group ',
  {
    ...
    [typeof props.horizontal === 'string' && props.horizontal.length ? `list-group-horizontal-${props.horizontal}` : 'list-group-horizontal']:
      props.horizontal || (typeof props.horizontal === 'string' && !props.horizontal)
  }
]
</script>
