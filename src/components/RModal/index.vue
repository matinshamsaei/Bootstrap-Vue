...
const modalHeaderClasses = [
  ...
  modalProps.headerClass,
  {
    ...
    [`border-${modalProps.headerBorderVariant}`]:
      modalProps.headerBorderVariant,
  },
];
...
const modalFooterClasses = [
  ...
  modalProps.footerClass,
  {
    ...
    [`border-${modalProps.footerBorderVariant}`]:
      modalProps.footerBorderVariant,
...
function hide(trigger: string = ""): void {
  ...
  if (
    (trigger === "backdrop" && modalProps.noCloseOnBackdrop) ||
    (trigger === "esc" && modalProps.noCloseOnEsc)
  ) {
    isVisible.value = true;
    return;
  }
  ...
  <teleport to="body" :disabled="modalProps.static">
    ...
    >
      ...
      >
        ...
        >
          <div
            :id="idGenerator('r_modal_dialog_')"
          ...
          >
            <div
              v-if="lazyShowing"
              :id="idGenerator('r_modal_content_')"
              :class="modalContentClasses"
            >
              <component
                v-if="!modalProps.hideHeader"
                :is="modalProps.headerTag"
              ...
              >
                ...
                <template v-else>
                  <component
                    ...
                    :is="modalProps.titleTag"
                    :class="modalTitleClasses"
                  >
                    <slot v-if="$slots['modal-title']" name="modal-title" />

                    <div
                      v-else-if="!!modalProps.titleHtml"
                      v-html="modalProps.titleHtml"
                    />
              ...
              <component
                v-if="!modalProps.hideFooter"
                :is="modalProps.footerTag"
              ...
              >
                ...
                <template v-else>
                  ...
                  >
                    ...
                    <div
                      v-else-if="!!modalProps.cancelTitleHtml"
                      v-html="modalProps.cancelTitleHtml"
                    />
                  ...
                  >
                    ...
                    <div
                      v-else-if="!!modalProps.okTitleHtml"
                      v-html="modalProps.okTitleHtml"
                    />
